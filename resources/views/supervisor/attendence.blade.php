              ...
              <tbody>
                @foreach($attendencesNow as $attendenceNow)
                  <tr>
                    ...
                    <td class="text-center">
                      <a href="{{url('/apprentices/' . Str::slug(strtolower($attendenceNow->name), '-') . '/' . $attendenceNow->id)}}" class="btn btn-info mr-2" style="font-size:.95rem" data-toggle="tooltip" data-placement="top" title="Lihat Logbook dan Absensi Peserta"><i class="ri-contacts-book-line"></i></a>
                    </td>
                  </tr>
                @endforeach
              </tbody>
